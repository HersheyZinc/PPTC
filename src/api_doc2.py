...
plan_APIs = [
    API(name="modify_slide", description="Modifies a slide according to the given slide index and instructions.", required=['idx', 'instructions'],
        parameters={
            'idx': {'description':'The ID of the slide to modify.', 'type':'integer'},
            'instruction': {'description':'Detailed instructions on how the slide should be modified.', 'type':'string'}
            }),
    API(name="new_slide", description="Creates a new slide and modify it according to the given instructions.", required=['instructions'],
        parameters={
            'instruction': {'description':'Detailed instructions on how the new slide should be modified.', 'type':'string'}
            }),
]
...
slide_APIs = [
    ...
    API(name="move_to_slide", description="Moves to the given slide id.", required=['idx'],
        parameters={'idx': {'description':'The ID of the slide to move to. Use a choose() function to reselect an object after this.', 'type':'integer'}}),
...
choose_APIs = [
    ...
    API(name="choose_content", description="Select the content element on the slide."),  
...
basic_APIs = [
    ...
    API(name="set_background_color", description="Sets the background color of the slide.", required=["color"],
        parameters={'color':{'description':'The color name to set as a string, such as red, purple.', 'type':'string'}})
]
...
text_APIs = [
    ...
    API(name="set_font_size", description="Sets font size of the selected text.", required=['size'],
        parameters={'size': {'description': 'Font size of text. Generally ranges from 1 to 92', 'type': 'integer'}}),
...
shape_APIs = [
    ...
    API(name="choose_shape", description="Selects a specific shape by shape name on the slide.", required=['shape_name'],
        parameters={"shape_name": {"description": "The name of the shape to be chosen. E.g. 'rectangle'", "type": "string"}}),
]
...
chart_APIs = [
    ...
    API(name="choose_chart", description="Selects the chart element on the slide."),
...
def get_API_toolkit(apis):
    return [api.format_input() for api in apis]
